...
const Table: Component<ComponentProps<"table"> & { outerClass?: string }> = (
  props
) => {
  const [local, others] = splitProps(props, ["class", "outerClass"]);
  return (
    <div class={cn("relative w-full overflow-auto", local.outerClass)}>
      <table
